...
namespace Api.Dao.V1
{
    public class StaffDao
    {
        ...
        public dynamic QuerySystemUserByPhoneNumber(string phoneNumber)
        {
            ...
            string sql = @"SELECT  A.XCXOPENID,A.FMOBILE,  A.FID, A.ISNEW, A.A3ID, l.FNUMBER FCHANNELCODE,A.FCHANNELID,A.FMOBILE,A.SALT,A.PASSWORD,B.FNAME, B.FJOB,B.FROLEID, C.FNAME AS CHANNELNAME,L.FCUSTOMERID,FCHANNELTYPEID,TTL.FNAME FCHANNELTYPENAME,CA.PICTURE,A.KHNAME
